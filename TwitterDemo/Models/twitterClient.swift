...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    static let shared = TwitterClient(baseURL: URL(string: "https://api.twitter.com"),
                                      consumerKey: "AFUQ3dWw0eDOsdE5VKsFvkuG6",
                                      consumerSecret: "n17SZZVEBlnNlSYdABYUqc2F74wOzy1WOfWm55R3FI3aHx0CWd")
    ...
    func loginSuccess(completion: @escaping (_ user: User?, _ error: NSError?) -> ()) {
        ...
        TwitterClient.shared?.fetchRequestToken(withPath: API_REQUEST_TOKEN, method: "GET", callbackURL: URL(string: "TwitterClientHieuNT://"), scope: nil, success: { (request: BDBOAuth1Credential?) in
